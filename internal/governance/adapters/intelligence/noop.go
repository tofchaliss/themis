...
func (NoopAdvisor) RecommendPosition(_ context.Context, _ string) (app.Recommendation, bool, app.NoProposal, error) {
	return app.Recommendation{}, false, app.NoProposal{Reason: app.ReasonAIDisabled}, nil
}
