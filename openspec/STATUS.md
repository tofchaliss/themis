...
Last updated: 2026-07-25 (**Phase-3 greenfield pivot** — the DDD bounded-context rebuild, per the
...
**M5 Event Infrastructure is grilled + scaffolded (2026-07-25):** `EDR-EVENTBUS-01` (D1–D11) +
`phase3-event-infrastructure` (0/42, 10 groups) — next to implement. See
`docs/engineering/PHASE3-STATUS.md`.)_
